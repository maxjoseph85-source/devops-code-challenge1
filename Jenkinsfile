pipeline {
    ...
    environment {
        ...
        FRONTEND_REPO = '792126555869.dkr.ecr.us-east-2.amazonaws.com/devops-challenge-frontend'
        BACKEND_REPO  = '792126555869.dkr.ecr.us-east-2.amazonaws.com/devops-challenge-backend'
    }
